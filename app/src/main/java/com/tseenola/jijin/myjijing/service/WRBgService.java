...
public class WRBgService extends Service {
    ...
    public void onCreate() {
        ...
        wakeLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, WRBgService.class.getName());
        wakeLock.acquire();
        //抓取数据
        getDataAndAnlyse();
    }
    ...
    private void parseData() {
        ...
        mPointValues_WR14 = new ArrayList<PointValue>();
        mDate = new ArrayList<>();
        Date date = new Date();
        ...
        for (int i = 0; i < lDataBeans.size(); i++) {
            ...
            mPointValues_WR14.add(new PointValue(i,(float)WRUtils.getWR(stdData,14)));
        }
    }
